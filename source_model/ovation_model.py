...
from season_epoch_Kp import get_dmsp_data, get_guvi_data, season_epoch_Kp
...
#start_date = dt.datetime(2017,9,5,0,0)
#end_date = dt.datetime(2017,9,5,0,5)
...
#   forecast_time = time_sw + dt.timedelta(seconds = lead_time)
    ...
    dmsp_data = get_dmsp_data(dmsp_path)
    guvi_data = get_guvi_data(guvi_path)
    ...
    # *********************   Call Main Routine **************************
        ...
        je = season_epoch_Kp( dmsp_data, guvi_data, sw_avg, mode, day_of_year,Kp_1)
        # ***************************************************************
