...
Input_path = '/home/rodney.viereck/python/ovation/Output/FORECAST/Text/North/'
Output_path = '/home/rodney.viereck/python/ovation/Final_Output/'
...
run_realtime = 0   #If = 1, then run once and use the standard "latest" file from the ovation model
if run_realtime == 1:
	run_once = 1
	plot_south = 1
	
output_global_ascii = 0   # Set this to 1 to get gridded ASCII output of global aurora distribution
...
while run_date <= end_date:
	for NS in range(ins):
		...
		ifl = 'aurora_N_2020-02-26_0900'
		print (Input_path + ifl)
