...
upper = 4.3		#Upper Limit for Aurora in plots	 in ergs/cm2/sec	
...
# 		
# 		plt.figtext(0.16,.03,'(erg/cm2)', color=fg_color,ha = "center")
# 		plt.figtext(0.3,.06,'>4', color=fg_color)		
# 		plt.figtext(0.07,.12,'10%               50%              90%      ', color = 'yellow', size =10)
# 		plt.figtext(0.16,.14,'Chance of Aurora', color = 'yellow', size =12, ha = "center")
